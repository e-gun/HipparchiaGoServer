...
func RtIndexMaker(c echo.Context) error {
	...
	globalwordcounts := db.GetMultipleWordCounts(gen.StringMapKeysIntoSlice(distinct))
	...
	ctl := strings.Replace(vv.INDEXANDVOCLISTCLICKTOLOOKUP, "**REPLACEME**", "indexobserved", 1)
