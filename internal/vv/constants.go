...
const (
	...
	CONFIGBASIC          = "hgs-vv.json"
	CONFIGPROLIX         = "hgs-prolix-vv.json"
	CONFIGVECTORW2V      = "hgs-vector-vv-w2v.json"
	CONFIGVECTORGLOVE    = "hgs-vector-vv-glove.json"
	CONFIGVECTORLEXVEC   = "hgs-vector-vv-lexvec.json"
	CONFIGVECTORLDA      = "hgs-vector-vv-lda.json"
