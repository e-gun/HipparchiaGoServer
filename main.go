...
func main() {
	// default.pgo, MEMProfile.pdf, and CPUProfile.pdf generated by changing "1 == 0" to "1 == 1" in the following,
	// then building, then running: ./HipparchiaGoServer -st
	// vectorless: ./HipparchiaGoServer -st -dv
