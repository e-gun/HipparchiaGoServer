...
func (tsne *TSNE) costGradient(P, Y mat.Matrix) float64 {
	...
	// profiling:
	// main (*TSNE) costGradient 210.80s (50.24%)
	//	math log 31.04s (7.40%) of 43.25s (10.31%)
	//	mat (*Dense) Apply 27.88s (6.64%) of 94.26s (22.46%)
	//  SquaredDistanceMatrix 7.13s (1.70%) of 64.76s (15.43%)
	// main (*TSNE) d2p 8.82s (2.92%) of 40.20s (13.32%)
